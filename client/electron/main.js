...
function createWindow() {
  const mainWindow = new BrowserWindow({
    ...
    resizable: true,
    webPreferences: {
      preload: path.join(__dirname, "appVarian634.js"),
  ...
  mainWindow.loadFile(path.join(__dirname, "appVarian634.html"));
...
ipcMain.on("open_json_file_sync", () => {
  ...
  fs.readFile("config.json", function (err, data) {
    ...
    printBoth("Called through ipc.send from appVarian634.js");
