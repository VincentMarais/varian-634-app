...
print(task_ni_pci_scanning(samples_per_channel=SAMPLES_PER_CHANNEL, sample_rate=SAMPLE_RATE, 
                    square_wave_frequency=Frequence_creneau, duty_cycle=Rapport_cyclique, channels=CHANNELS[0]))
